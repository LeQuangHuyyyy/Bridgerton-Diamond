...
export const Table: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        result.content.some((account: { email: string; phoneNumber: string; }) => {
    ...
    const searchAdminHandleChange = async (value: string) => {
        if (
            value.toLowerCase() === 'admin' ||
            value.toLowerCase() === 'manager' ||
            value.toLowerCase() === 'sale_staff' ||
            value.toLowerCase() === 'delivery_staff' ||
            ...
            const data = await response.json();
            setDataSource(data.content || []);
            dataSource.filter((role: any) => role.role === searchCategory);
    ...
    return (
        <div className="mt-5 mb-3 ms-2 me-2 d-flex flex-column gap-3">
                    ...
                    <form className="mx-auto ms-3 w-100 max-w-lg">
                        <div className="d-flex justify-content-start w-25">
                            ...
                            <div id="dropdown" className="dropdown-menu" style={{width: '200px'}}>
                                <ul className="role">
                                    <li onClick={() => searchAdminHandleChange('admin')}>
                                    ...
                                    <li onClick={() => searchAdminHandleChange('DELIVERY_STAFF')}>
                                        <button id="dropdown-button" type="button"
                                    ...
                                    <li onClick={() => searchAdminHandleChange('SALE_STAFF')}>
                                        <button id="dropdown-button" type="button"
                                    ...
                                    <li onClick={() => searchAdminHandleChange('CUSTOMER')}>
                                        <button id="dropdown-button" type="button"
                                                className="btn text-start" value="CUSTOMER">
                                            Customer
                                        </button>
                                    </li>
                                    <li onClick={() => searchAdminHandleChange('MANAGER')}>
                                        <button id="dropdown-button" type="button"
