    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/manage/diamond-price/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/manage/shell/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/payment/VNPayBack/**").permitAll()
